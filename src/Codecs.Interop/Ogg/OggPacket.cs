...
namespace Codecs.Interop.Ogg
{
	...
	public class OggPacket
	{
        ...
        {
            return string.Format("OggPacket [Eos: {0}, Bos: {1}, Granulepos: {2}, Packetno: {3}, Bytes: {4}, Packet: {5}]", this.E_o_s, this.B_o_s, this.Granulepos, this.Packetno, this.Bytes, BitConverter.ToString(this.Packet).Replace("-",""));
        }
