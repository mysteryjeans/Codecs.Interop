...
namespace Codecs.Interop.Ogg
{
    ...
    /// </summary>
    public class OggStreamState : IDisposable
    {
        #region Variables
        ...
        public int B_o_s
        {
            get { return this.ogg_stream_state.b_o_s; }
            set { this.ogg_stream_state.b_o_s = value; }
        }

        public int HeaderFill
        {
            get { return this.ogg_stream_state.header_fill; }
        }

        public int BodyReturned
        {
            get { return this.ogg_stream_state.body_returned; }
        }

        public int BodyFill
        {
            get { return this.ogg_stream_state.body_fill; }
        }

        public int SerialNo
        {
            get { return this.ogg_stream_state.serialno; }
        }
        ...
        private void MarshalData()
        {
            if (this.changed)
            {
                this.header = new byte[this.HeaderFill];
                Array.Copy(this.ogg_stream_state.header, this.header, this.HeaderFill);

                this.body = new byte[this.BodyReturned];
                Marshal.Copy(this.ogg_stream_state.body_data, body, 0, this.BodyReturned);
